      ...
      <Dots />
        <div className="container whoWeAre__Wraper">
            <div className="WhoWeAre__content">
              <h2>Who We Are</h2>
              <p>TEK2D provides a wide range of unique web development services that will make your business flourish to the maximum. Just ask us and we will make you the best website with the team of professionals that are there only for you.</p>
